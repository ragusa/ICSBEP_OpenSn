...
# -*- coding: utf-8 -*-
"""
IEU_MET_FAST_005 case-2 benchmark
"""
...
if __name__ == "__main__":
    ...
    radii = {1: 2.6859999999999999, 2: 13.25, 3: 15, 4: 21.5}
    ...
    xs_shell3.LoadFromOpenMC("./materials/material_2_Steel_reflector_#1/Steel_reflector_#1_LANL70g.h5", "Steel_reflector_#1", 294.0)
    xs_shell3.SetScalingFactor(ratios[2])

    xs_shell4 = MultiGroupXS()
    xs_shell4.LoadFromOpenMC("./materials/material_3_Steel_reflector_#2/Steel_reflector_#2_LANL70g.h5", "Steel_reflector_#2", 294.0)
    ...
    vtk_basename = "IEU_MET_FAST_005_case-2"
