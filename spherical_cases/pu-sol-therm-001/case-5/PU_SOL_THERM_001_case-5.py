...
# -*- coding: utf-8 -*-
"""
PU_SOL_THERM_001 case-5 benchmark
"""
...
if __name__ == "__main__":
    ...
    radii = {1: 14.530200000000001, 2: 14.6547, 3: 44.654699999999998}
    ...
    xs_shell2.LoadFromOpenMC("./materials/material_2_Stainless_steel/Stainless_steel_LANL70g.h5", "Stainless_steel", 294.0)
    xs_shell2.SetScalingFactor(ratios[1])

    xs_shell3 = MultiGroupXS()
    xs_shell3.LoadFromOpenMC("./materials/material_3_Water_at_25_C/Water_at_25_C_LANL70g.h5", "Water_at_25_C", 294.0)
    ...
    vtk_basename = "PU_SOL_THERM_001_case-5"
