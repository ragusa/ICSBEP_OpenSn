...
# -*- coding: utf-8 -*-
"""
SPEC_MET_FAST_003 case-1 benchmark
"""
...
if __name__ == "__main__":
    ...
    meshgen = FromFileMeshGenerator(
        filename="./mesh/n_shells_sphere_5_shells.msh",
    ...
    radii = {1: 0.69210000000000005, 2: 0.70620000000000005, 3: 0.72660000000000002, 4: 6.1155999999999997, 5: 24.124199999999998}
    ...
    xs_shell2.LoadFromOpenMC("./materials/material_2_mat_2/mat_2_LANL70g.h5", "mat_2", 294.0)
    xs_shell2.SetScalingFactor(ratios[1])

    xs_shell3 = MultiGroupXS()
    xs_shell3.LoadFromOpenSn(void_xs_path)
    xs_shell3.SetScalingFactor(ratios[2])
    if rank == 0:
        print("Shell 3: using void XS ->", void_xs_path)

    xs_shell4 = MultiGroupXS()
    xs_shell4.LoadFromOpenMC("./materials/material_3_mat_3/mat_3_LANL70g.h5", "mat_3", 294.0)
    xs_shell4.SetScalingFactor(ratios[3])

    xs_shell5 = MultiGroupXS()
    xs_shell5.LoadFromOpenMC("./materials/material_4_mat_4/mat_4_LANL70g.h5", "mat_4", 294.0)
    ...
    vtk_basename = "SPEC_MET_FAST_003_case-1"
