...
# -*- coding: utf-8 -*-
"""
IEU_MET_FAST_009 case-1 benchmark
"""
...
if __name__ == "__main__":
    ...
    radii = {1: 3.4449999999999998, 2: 6, 3: 7.5499999999999998, 4: 9.1500000000000004, 5: 11, 6: 12.25, 7: 15.15, 8: 18}
    ...
    xs_shell2.LoadFromOpenMC("./materials/material_1_36_wt%_U-235,_Layer_1/36_wt%_U-235,_Layer_1_LANL70g.h5", "36_wt%_U-235,_Layer_1", 294.0)
    xs_shell2.SetScalingFactor(ratios[1])

    xs_shell3 = MultiGroupXS()
    xs_shell3.LoadFromOpenMC("./materials/material_2_36_wt%_U-235,_Layer_2/36_wt%_U-235,_Layer_2_LANL70g.h5", "36_wt%_U-235,_Layer_2", 294.0)
    xs_shell3.SetScalingFactor(ratios[2])

    xs_shell4 = MultiGroupXS()
    xs_shell4.LoadFromOpenMC("./materials/material_3_36_wt%_U-235,_Layer_3/36_wt%_U-235,_Layer_3_LANL70g.h5", "36_wt%_U-235,_Layer_3", 294.0)
    xs_shell4.SetScalingFactor(ratios[3])

    xs_shell5 = MultiGroupXS()
    xs_shell5.LoadFromOpenMC("./materials/material_4_36_wt%_U-235,_Layer_4/36_wt%_U-235,_Layer_4_LANL70g.h5", "36_wt%_U-235,_Layer_4", 294.0)
    xs_shell5.SetScalingFactor(ratios[4])

    xs_shell6 = MultiGroupXS()
    xs_shell6.LoadFromOpenMC("./materials/material_5_36_wt%_U-235,_Layer_5/36_wt%_U-235,_Layer_5_LANL70g.h5", "36_wt%_U-235,_Layer_5", 294.0)
    xs_shell6.SetScalingFactor(ratios[5])

    xs_shell7 = MultiGroupXS()
    xs_shell7.LoadFromOpenMC("./materials/material_6_Polyethylene,_Layer_1/Polyethylene,_Layer_1_LANL70g.h5", "Polyethylene,_Layer_1", 294.0)
    xs_shell7.SetScalingFactor(ratios[6])

    xs_shell8 = MultiGroupXS()
    xs_shell8.LoadFromOpenMC("./materials/material_7_Polyethylene,_Layer_2/Polyethylene,_Layer_2_LANL70g.h5", "Polyethylene,_Layer_2", 294.0)
    ...
    vtk_basename = "IEU_MET_FAST_009_case-1"
