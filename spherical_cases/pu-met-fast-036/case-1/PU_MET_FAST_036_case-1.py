...
# -*- coding: utf-8 -*-
"""
PU_MET_FAST_036 case-1 benchmark
"""
...
if __name__ == "__main__":
    ...
    radii = {1: 1.1599999999999999, 2: 1.3999999999999999, 3: 3.1499999999999999, 4: 4.0199999999999996, 5: 4.6600000000000001, 6: 5.3499999999999996, 7: 6, 8: 6.0499999999999998, 9: 6.75, 10: 7.5499999999999998, 11: 8.3499999999999996}
    ...
    xs_shell8.LoadFromOpenMC("./materials/material_7_Cadmium_reflector/Cadmium_reflector_LANL70g.h5", "Cadmium_reflector", 294.0)
    xs_shell8.SetScalingFactor(ratios[7])

    xs_shell9 = MultiGroupXS()
    xs_shell9.LoadFromOpenMC("./materials/material_8_Polyethlyene_reflector,_layer_1/Polyethlyene_reflector,_layer_1_LANL70g.h5", "Polyethlyene_reflector,_layer_1", 294.0)
    xs_shell9.SetScalingFactor(ratios[8])

    xs_shell10 = MultiGroupXS()
    xs_shell10.LoadFromOpenMC("./materials/material_9_Polyethlyene_reflector,_layer_2/Polyethlyene_reflector,_layer_2_LANL70g.h5", "Polyethlyene_reflector,_layer_2", 294.0)
    xs_shell10.SetScalingFactor(ratios[9])

    xs_shell11 = MultiGroupXS()
    xs_shell11.LoadFromOpenMC("./materials/material_10_Polyethlyene_reflector,_layer_3/Polyethlyene_reflector,_layer_3_LANL70g.h5", "Polyethlyene_reflector,_layer_3", 294.0)
    ...
    vtk_basename = "PU_MET_FAST_036_case-1"
