...
# -*- coding: utf-8 -*-
"""
PU_MET_FAST_026 case-1 benchmark
"""
...
if __name__ == "__main__":
    ...
    meshgen = FromFileMeshGenerator(
        filename="./mesh/n_shells_sphere_8_shells.msh",
    ...
    radii = {1: 0.77000000000000002, 2: 1.3999999999999999, 3: 3.1499999999999999, 4: 4.0199999999999996, 5: 4.6600000000000001, 6: 5.3499999999999996, 7: 11, 8: 17.25}
    ...
    xs_shell2.LoadFromOpenMC("./materials/material_1_98%_Pu-239_in_delta_phase/98%_Pu-239_in_delta_phase_LANL70g.h5", "98%_Pu-239_in_delta_phase", 294.0)
    xs_shell2.SetScalingFactor(ratios[1])

    xs_shell3 = MultiGroupXS()
    xs_shell3.LoadFromOpenMC("./materials/material_2_98%_Pu-239_in_delta_phase/98%_Pu-239_in_delta_phase_LANL70g.h5", "98%_Pu-239_in_delta_phase", 294.0)
    xs_shell3.SetScalingFactor(ratios[2])

    xs_shell4 = MultiGroupXS()
    xs_shell4.LoadFromOpenMC("./materials/material_3_98%_Pu-239_in_delta_phase/98%_Pu-239_in_delta_phase_LANL70g.h5", "98%_Pu-239_in_delta_phase", 294.0)
    xs_shell4.SetScalingFactor(ratios[3])

    xs_shell5 = MultiGroupXS()
    xs_shell5.LoadFromOpenMC("./materials/material_4_98%_Pu-239_in_delta_phase/98%_Pu-239_in_delta_phase_LANL70g.h5", "98%_Pu-239_in_delta_phase", 294.0)
    xs_shell5.SetScalingFactor(ratios[4])

    xs_shell6 = MultiGroupXS()
    xs_shell6.LoadFromOpenMC("./materials/material_5_98%_Pu-239_in_delta_phase/98%_Pu-239_in_delta_phase_LANL70g.h5", "98%_Pu-239_in_delta_phase", 294.0)
    xs_shell6.SetScalingFactor(ratios[5])

    xs_shell7 = MultiGroupXS()
    xs_shell7.LoadFromOpenMC("./materials/material_6_Steel_reflector_1/Steel_reflector_1_LANL70g.h5", "Steel_reflector_1", 294.0)
    xs_shell7.SetScalingFactor(ratios[6])

    xs_shell8 = MultiGroupXS()
    xs_shell8.LoadFromOpenMC("./materials/material_7_Steel_reflector_2/Steel_reflector_2_LANL70g.h5", "Steel_reflector_2", 294.0)
    ...
    vtk_basename = "PU_MET_FAST_026_case-1"
