...
# -*- coding: utf-8 -*-
"""
PU_MET_FAST_026 case-2 benchmark
"""
...
if __name__ == "__main__":
    ...
    radii = {1: 0.77000000000000002, 2: 5.3499999999999996, 3: 11, 4: 17.25}
    ...
    xs_shell3.LoadFromOpenMC("./materials/material_2_Steel_reflector_1/Steel_reflector_1_LANL70g.h5", "Steel_reflector_1", 294.0)
    xs_shell3.SetScalingFactor(ratios[2])

    xs_shell4 = MultiGroupXS()
    xs_shell4.LoadFromOpenMC("./materials/material_3_Steel_reflector_2/Steel_reflector_2_LANL70g.h5", "Steel_reflector_2", 294.0)
    ...
    vtk_basename = "PU_MET_FAST_026_case-2"
