...
# -*- coding: utf-8 -*-
"""
PU_MET_FAST_023 case-1 benchmark
"""
...
if __name__ == "__main__":
    ...
    radii = {1: 1.7150000000000001, 2: 3.1499999999999999, 3: 4.0199999999999996, 4: 4.6600000000000001, 5: 5.3499999999999996, 6: 6, 7: 8.3499999999999996}
    ...
    xs_shell2.LoadFromOpenMC("./materials/material_1_98%_Pu-239_in_delta_phase,_layer_1/98%_Pu-239_in_delta_phase,_layer_1_LANL70g.h5", "98%_Pu-239_in_delta_phase,_layer_1", 294.0)
    xs_shell2.SetScalingFactor(ratios[1])

    xs_shell3 = MultiGroupXS()
    xs_shell3.LoadFromOpenMC("./materials/material_2_98%_Pu-239_in_delta_phase,_layer_2/98%_Pu-239_in_delta_phase,_layer_2_LANL70g.h5", "98%_Pu-239_in_delta_phase,_layer_2", 294.0)
    xs_shell3.SetScalingFactor(ratios[2])

    xs_shell4 = MultiGroupXS()
    xs_shell4.LoadFromOpenMC("./materials/material_3_98%_Pu-239_in_delta_phase,_layer_3/98%_Pu-239_in_delta_phase,_layer_3_LANL70g.h5", "98%_Pu-239_in_delta_phase,_layer_3", 294.0)
    xs_shell4.SetScalingFactor(ratios[3])

    xs_shell5 = MultiGroupXS()
    xs_shell5.LoadFromOpenMC("./materials/material_4_98%_Pu-239_in_delta_phase,_layer_4/98%_Pu-239_in_delta_phase,_layer_4_LANL70g.h5", "98%_Pu-239_in_delta_phase,_layer_4", 294.0)
    xs_shell5.SetScalingFactor(ratios[4])

    xs_shell6 = MultiGroupXS()
    xs_shell6.LoadFromOpenMC("./materials/material_5_98%_Pu-239_in_delta_phase,_layer_5/98%_Pu-239_in_delta_phase,_layer_5_LANL70g.h5", "98%_Pu-239_in_delta_phase,_layer_5", 294.0)
    xs_shell6.SetScalingFactor(ratios[5])

    xs_shell7 = MultiGroupXS()
    xs_shell7.LoadFromOpenMC("./materials/material_6_c_Graphite/c_Graphite_LANL70g.h5", "c_Graphite", 294.0)
    ...
    vtk_basename = "PU_MET_FAST_023_case-1"
