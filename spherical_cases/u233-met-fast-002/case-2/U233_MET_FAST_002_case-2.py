...
# -*- coding: utf-8 -*-
"""
U233_MET_FAST_002 case-2 benchmark
"""
...
if __name__ == "__main__":
    ...
    radii = {1: 4.5998999999999999, 2: 6.5887000000000002}
    ...
    xs_shell1.LoadFromOpenMC("./materials/material_1_U233_Inner_Sphere/U233_Inner_Sphere_LANL70g.h5", "U233_Inner_Sphere", 294.0)
    xs_shell1.SetScalingFactor(ratios[0])

    xs_shell2 = MultiGroupXS()
    xs_shell2.LoadFromOpenMC("./materials/material_2_U235_Outer_Shell/U235_Outer_Shell_LANL70g.h5", "U235_Outer_Shell", 294.0)
    ...
    vtk_basename = "U233_MET_FAST_002_case-2"
