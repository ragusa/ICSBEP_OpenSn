...
# -*- coding: utf-8 -*-
"""
IEU_MET_FAST_006 case-2 benchmark
"""
...
if __name__ == "__main__":
    ...
    radii = {1: 2.1000000000000001, 2: 13.25, 3: 15, 4: 25}
    ...
    xs_shell2.LoadFromOpenMC("./materials/material_1_36_wt%_U-235/36_wt%_U-235_LANL70g.h5", "36_wt%_U-235", 294.0)
    xs_shell2.SetScalingFactor(ratios[1])

    xs_shell3 = MultiGroupXS()
    xs_shell3.LoadFromOpenMC("./materials/material_2_Duralumin_reflector_#1/Duralumin_reflector_#1_LANL70g.h5", "Duralumin_reflector_#1", 294.0)
    xs_shell3.SetScalingFactor(ratios[2])

    xs_shell4 = MultiGroupXS()
    xs_shell4.LoadFromOpenMC("./materials/material_3_Duralumin_reflector_#2/Duralumin_reflector_#2_LANL70g.h5", "Duralumin_reflector_#2", 294.0)
    ...
    vtk_basename = "IEU_MET_FAST_006_case-2"
