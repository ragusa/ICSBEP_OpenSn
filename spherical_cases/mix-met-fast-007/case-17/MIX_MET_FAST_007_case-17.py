...
# -*- coding: utf-8 -*-
"""
MIX_MET_FAST_007 case-17 benchmark
"""
...
if __name__ == "__main__":
    ...
    radii = {1: 3.6537000000000002, 2: 5.1612999999999998, 3: 8.0612999999999992}
    ...
    xs_shell1.LoadFromOpenMC("./materials/material_1_Pu_core/Pu_core_LANL70g.h5", "Pu_core", 294.0)
    xs_shell1.SetScalingFactor(ratios[0])

    xs_shell2 = MultiGroupXS()
    xs_shell2.LoadFromOpenMC("./materials/material_2_HEU/HEU_LANL70g.h5", "HEU", 294.0)
    xs_shell2.SetScalingFactor(ratios[1])

    xs_shell3 = MultiGroupXS()
    xs_shell3.LoadFromOpenMC("./materials/material_3_Beryllium/Beryllium_LANL70g.h5", "Beryllium", 294.0)
    ...
    vtk_basename = "MIX_MET_FAST_007_case-17"
