...
# -*- coding: utf-8 -*-
"""
PU_MET_FAST_006 case-1 benchmark
"""
...
if __name__ == "__main__":
    ...
    radii = {1: 4.5331999999999999, 2: 24.141999999999999}
    ...
    xs_shell1.LoadFromOpenMC("./materials/material_1_Core/Core_LANL70g.h5", "Core", 294.0)
    xs_shell1.SetScalingFactor(ratios[0])

    xs_shell2 = MultiGroupXS()
    xs_shell2.LoadFromOpenMC("./materials/material_2_Reflector/Reflector_LANL70g.h5", "Reflector", 294.0)
    ...
    vtk_basename = "PU_MET_FAST_006_case-1"
