...
# -*- coding: utf-8 -*-
"""
PU_SOL_THERM_003 case-3 benchmark
"""
...
if __name__ == "__main__":
    ...
    radii = {1: 16.515599999999999, 2: 16.642600000000002, 3: 46.642600000000002}
    ...
    xs_shell1.LoadFromOpenMC("./materials/material_1_Plutonium_nitrate_solution/Plutonium_nitrate_solution_LANL70g.h5", "Plutonium_nitrate_solution", 294.0)
    xs_shell1.SetScalingFactor(ratios[0])

    xs_shell2 = MultiGroupXS()
    xs_shell2.LoadFromOpenMC("./materials/material_2_347_stainless_steel/347_stainless_steel_LANL70g.h5", "347_stainless_steel", 294.0)
    xs_shell2.SetScalingFactor(ratios[1])

    xs_shell3 = MultiGroupXS()
    xs_shell3.LoadFromOpenMC("./materials/material_3_Water_at_27_C/Water_at_27_C_LANL70g.h5", "Water_at_27_C", 294.0)
    ...
    vtk_basename = "PU_SOL_THERM_003_case-3"
