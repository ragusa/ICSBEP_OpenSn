...
# -*- coding: utf-8 -*-
"""
HEU_SOL_THERM_032 case-1 benchmark
"""
...
if __name__ == "__main__":
    ...
    radii = {1: 61.011000000000003, 2: 61.786000000000001}
    ...
    xs_shell1.LoadFromOpenMC("./materials/material_1_Uranium_Nitrate_Solution/Uranium_Nitrate_Solution_LANL70g.h5", "Uranium_Nitrate_Solution", 294.0)
    xs_shell1.SetScalingFactor(ratios[0])

    xs_shell2 = MultiGroupXS()
    xs_shell2.LoadFromOpenMC("./materials/material_2_Type_1100_Aluminum/Type_1100_Aluminum_LANL70g.h5", "Type_1100_Aluminum", 294.0)
    ...
    vtk_basename = "HEU_SOL_THERM_032_case-1"
