...
# -*- coding: utf-8 -*-
"""
U233_MET_FAST_005 case-1 benchmark
"""
...
if __name__ == "__main__":
    ...
    radii = {1: 5.0444000000000004, 2: 7.0891000000000002}
    ...
    xs_shell1.LoadFromOpenMC("./materials/material_1_U233_core/U233_core_LANL70g.h5", "U233_core", 294.0)
    xs_shell1.SetScalingFactor(ratios[0])

    xs_shell2 = MultiGroupXS()
    xs_shell2.LoadFromOpenMC("./materials/material_2_Beryllium_reflector/Beryllium_reflector_LANL70g.h5", "Beryllium_reflector", 294.0)
    ...
    vtk_basename = "U233_MET_FAST_005_case-1"
