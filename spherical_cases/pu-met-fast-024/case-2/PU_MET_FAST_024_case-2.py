...
# -*- coding: utf-8 -*-
"""
PU_MET_FAST_024 case-2 benchmark
"""
...
if __name__ == "__main__":
    ...
    radii = {1: 6, 2: 7.5499999999999998}
    ...
    xs_shell1.LoadFromOpenMC("./materials/material_1_98%_Pu-239_in_delta_phase/98%_Pu-239_in_delta_phase_LANL70g.h5", "98%_Pu-239_in_delta_phase", 294.0)
    xs_shell1.SetScalingFactor(ratios[0])

    xs_shell2 = MultiGroupXS()
    xs_shell2.LoadFromOpenMC("./materials/material_2_Polyethylene/Polyethylene_LANL70g.h5", "Polyethylene", 294.0)
    ...
    vtk_basename = "PU_MET_FAST_024_case-2"
