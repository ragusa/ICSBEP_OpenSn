...
# -*- coding: utf-8 -*-
"""
HEU_MET_FAST_058 case-5 benchmark
"""
...
if __name__ == "__main__":
    ...
    radii = {1: 0.49830000000000002, 2: 0.52070000000000005, 3: 0.55549999999999999, 4: 7.4790000000000001, 5: 9.7014999999999993}
    ...
    xs_shell1.LoadFromOpenMC("./materials/material_1_Beryllium_(internal)/Beryllium_(internal)_LANL70g.h5", "Beryllium_(internal)", 294.0)
    ...
    xs_shell4.LoadFromOpenMC("./materials/material_4_HEU/HEU_LANL70g.h5", "HEU", 294.0)
    xs_shell4.SetScalingFactor(ratios[3])

    xs_shell5 = MultiGroupXS()
    xs_shell5.LoadFromOpenMC("./materials/material_5_Beryllium_(outer)/Beryllium_(outer)_LANL70g.h5", "Beryllium_(outer)", 294.0)
    ...
    vtk_basename = "HEU_MET_FAST_058_case-5"
