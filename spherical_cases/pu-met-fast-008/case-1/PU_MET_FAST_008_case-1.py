...
# -*- coding: utf-8 -*-
"""
PU_MET_FAST_008 case-1 benchmark
"""
...
if __name__ == "__main__":
    ...
    radii = {1: 5.3099999999999996, 2: 29.879999999999999}
    ...
    xs_shell1.LoadFromOpenMC("./materials/material_1_Plutonium_core/Plutonium_core_LANL70g.h5", "Plutonium_core", 294.0)
    xs_shell1.SetScalingFactor(ratios[0])

    xs_shell2 = MultiGroupXS()
    xs_shell2.LoadFromOpenMC("./materials/material_2_Thorium_reflector/Thorium_reflector_LANL70g.h5", "Thorium_reflector", 294.0)
    ...
    vtk_basename = "PU_MET_FAST_008_case-1"
