...
# -*- coding: utf-8 -*-
"""
PU_MET_FAST_039 case-1 benchmark
"""
...
if __name__ == "__main__":
    ...
    radii = {1: 3.1120000000000001, 2: 4.0199999999999996, 3: 4.6600000000000001, 4: 5.3499999999999996, 5: 6, 6: 6.75, 7: 8.3499999999999996, 8: 9.1500000000000004, 9: 11}
    ...
    xs_shell7.LoadFromOpenMC("./materials/material_6_Duralumin_reflector,_layer_1/Duralumin_reflector,_layer_1_LANL70g.h5", "Duralumin_reflector,_layer_1", 294.0)
    xs_shell7.SetScalingFactor(ratios[6])

    xs_shell8 = MultiGroupXS()
    xs_shell8.LoadFromOpenMC("./materials/material_7_Duralumin_reflector,_layer_2/Duralumin_reflector,_layer_2_LANL70g.h5", "Duralumin_reflector,_layer_2", 294.0)
    xs_shell8.SetScalingFactor(ratios[7])

    xs_shell9 = MultiGroupXS()
    xs_shell9.LoadFromOpenMC("./materials/material_8_Duralumin_reflector,_layer_3/Duralumin_reflector,_layer_3_LANL70g.h5", "Duralumin_reflector,_layer_3", 294.0)
    ...
    vtk_basename = "PU_MET_FAST_039_case-1"
