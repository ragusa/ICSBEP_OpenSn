...
# -*- coding: utf-8 -*-
"""
HEU_MET_FAST_066 case-4 benchmark
"""
...
if __name__ == "__main__":
    ...
    radii = {1: 0.49830000000000002, 2: 0.52070000000000005, 3: 0.55549999999999999, 4: 4.0895000000000001, 5: 6.5445000000000002, 6: 19.744499999999999}
    ...
    xs_shell1.LoadFromOpenMC("./materials/material_1_Beryllium_(source)/Beryllium_(source)_LANL70g.h5", "Beryllium_(source)", 294.0)
    xs_shell1.SetScalingFactor(ratios[0])

    xs_shell2 = MultiGroupXS()
    xs_shell2.LoadFromOpenMC("./materials/material_2_Nickel/Nickel_LANL70g.h5", "Nickel", 294.0)
    ...
    xs_shell4.LoadFromOpenMC("./materials/material_4_Beryllium_(moderator_reflector)/Beryllium_(moderator_reflector)_LANL70g.h5", "Beryllium_(moderator_reflector)", 294.0)
    xs_shell4.SetScalingFactor(ratios[3])

    xs_shell5 = MultiGroupXS()
    xs_shell5.LoadFromOpenMC("./materials/material_5_HEU/HEU_LANL70g.h5", "HEU", 294.0)
    xs_shell5.SetScalingFactor(ratios[4])

    xs_shell6 = MultiGroupXS()
    xs_shell6.LoadFromOpenMC("./materials/material_4_Beryllium_(moderator_reflector)/Beryllium_(moderator_reflector)_LANL70g.h5", "Beryllium_(moderator_reflector)", 294.0)
    ...
    vtk_basename = "HEU_MET_FAST_066_case-4"
