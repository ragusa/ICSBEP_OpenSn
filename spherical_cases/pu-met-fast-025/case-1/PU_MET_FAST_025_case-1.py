...
# -*- coding: utf-8 -*-
"""
PU_MET_FAST_025 case-1 benchmark
"""
...
if __name__ == "__main__":
    ...
    radii = {1: 1.3999999999999999, 2: 3.1499999999999999, 3: 4.0199999999999996, 4: 4.6600000000000001, 5: 5.3499999999999996, 6: 6, 7: 7.5499999999999998}
    ...
    xs_shell1.LoadFromOpenMC("./materials/material_1_Layer_1/Layer_1_LANL70g.h5", "Layer_1", 294.0)
    xs_shell1.SetScalingFactor(ratios[0])

    xs_shell2 = MultiGroupXS()
    xs_shell2.LoadFromOpenMC("./materials/material_2_Layer_2/Layer_2_LANL70g.h5", "Layer_2", 294.0)
    xs_shell2.SetScalingFactor(ratios[1])

    xs_shell3 = MultiGroupXS()
    xs_shell3.LoadFromOpenMC("./materials/material_3_Layer_3/Layer_3_LANL70g.h5", "Layer_3", 294.0)
    xs_shell3.SetScalingFactor(ratios[2])

    xs_shell4 = MultiGroupXS()
    xs_shell4.LoadFromOpenMC("./materials/material_4_Layer_4/Layer_4_LANL70g.h5", "Layer_4", 294.0)
    xs_shell4.SetScalingFactor(ratios[3])

    xs_shell5 = MultiGroupXS()
    xs_shell5.LoadFromOpenMC("./materials/material_5_Layer_5/Layer_5_LANL70g.h5", "Layer_5", 294.0)
    xs_shell5.SetScalingFactor(ratios[4])

    xs_shell6 = MultiGroupXS()
    xs_shell6.LoadFromOpenMC("./materials/material_6_Layer_6/Layer_6_LANL70g.h5", "Layer_6", 294.0)
    xs_shell6.SetScalingFactor(ratios[5])

    xs_shell7 = MultiGroupXS()
    xs_shell7.LoadFromOpenMC("./materials/material_7_Steel_reflector/Steel_reflector_LANL70g.h5", "Steel_reflector", 294.0)
    ...
    vtk_basename = "PU_MET_FAST_025_case-1"
