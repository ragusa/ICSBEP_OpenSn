...
# -*- coding: utf-8 -*-
"""
HEU_MET_FAST_001 case-1 benchmark
"""
...
if __name__ == "__main__":
    ...
    meshgen = FromFileMeshGenerator(
        filename="./mesh/n_shells_sphere_10_shells.msh",
    ...
    radii = {1: 1.0216000000000001, 2: 1.0541, 3: 6.2808999999999999, 4: 6.2937000000000003, 5: 7.7525000000000004, 6: 7.7619999999999996, 7: 8.2527000000000008, 8: 8.2609999999999992, 9: 8.7062000000000008, 10: 8.7499000000000002}
    ...
    xs_shell1.LoadFromOpenMC("./materials/material_1_mat_1/mat_1_LANL70g.h5", "mat_1", 294.0)
    xs_shell1.SetScalingFactor(ratios[0])

    xs_shell2 = MultiGroupXS()
    xs_shell2.LoadFromOpenMC("./materials/material_7_mat_7/mat_7_LANL70g.h5", "mat_7", 294.0)
    xs_shell2.SetScalingFactor(ratios[1])

    xs_shell3 = MultiGroupXS()
    xs_shell3.LoadFromOpenMC("./materials/material_2_mat_2/mat_2_LANL70g.h5", "mat_2", 294.0)
    xs_shell3.SetScalingFactor(ratios[2])

    xs_shell4 = MultiGroupXS()
    xs_shell4.LoadFromOpenMC("./materials/material_7_mat_7/mat_7_LANL70g.h5", "mat_7", 294.0)
    xs_shell4.SetScalingFactor(ratios[3])

    xs_shell5 = MultiGroupXS()
    xs_shell5.LoadFromOpenMC("./materials/material_3_mat_3/mat_3_LANL70g.h5", "mat_3", 294.0)
    xs_shell5.SetScalingFactor(ratios[4])

    xs_shell6 = MultiGroupXS()
    xs_shell6.LoadFromOpenMC("./materials/material_7_mat_7/mat_7_LANL70g.h5", "mat_7", 294.0)
    xs_shell6.SetScalingFactor(ratios[5])

    xs_shell7 = MultiGroupXS()
    xs_shell7.LoadFromOpenMC("./materials/material_4_mat_4/mat_4_LANL70g.h5", "mat_4", 294.0)
    xs_shell7.SetScalingFactor(ratios[6])

    xs_shell8 = MultiGroupXS()
    xs_shell8.LoadFromOpenMC("./materials/material_7_mat_7/mat_7_LANL70g.h5", "mat_7", 294.0)
    xs_shell8.SetScalingFactor(ratios[7])

    xs_shell9 = MultiGroupXS()
    xs_shell9.LoadFromOpenMC("./materials/material_5_mat_5/mat_5_LANL70g.h5", "mat_5", 294.0)
    xs_shell9.SetScalingFactor(ratios[8])

    xs_shell10 = MultiGroupXS()
    xs_shell10.LoadFromOpenMC("./materials/material_6_mat_6/mat_6_LANL70g.h5", "mat_6", 294.0)
    ...
    vtk_basename = "HEU_MET_FAST_001_case-1"
