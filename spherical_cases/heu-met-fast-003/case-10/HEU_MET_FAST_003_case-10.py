...
# -*- coding: utf-8 -*-
"""
HEU_MET_FAST_003 case-10 benchmark
"""
...
if __name__ == "__main__":
    ...
    radii = {1: 6.0509000000000004, 2: 17.480899999999998}
    ...
    xs_shell1.LoadFromOpenMC("./materials/material_1_Oralloy/Oralloy_LANL70g.h5", "Oralloy", 294.0)
    xs_shell1.SetScalingFactor(ratios[0])

    xs_shell2 = MultiGroupXS()
    xs_shell2.LoadFromOpenMC("./materials/material_2_Tungsten_carbide/Tungsten_carbide_LANL70g.h5", "Tungsten_carbide", 294.0)
    ...
    vtk_basename = "HEU_MET_FAST_003_case-10"
