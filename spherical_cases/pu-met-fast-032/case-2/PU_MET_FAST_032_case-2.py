...
# -*- coding: utf-8 -*-
"""
PU_MET_FAST_032 case-2 benchmark
"""
...
if __name__ == "__main__":
    ...
    radii = {1: 0.69999999999999996, 2: 4.6600000000000001, 3: 9.1500000000000004}
    ...
    xs_shell2.LoadFromOpenMC("./materials/material_1_mat_1/mat_1_LANL70g.h5", "mat_1", 294.0)
    xs_shell2.SetScalingFactor(ratios[1])

    xs_shell3 = MultiGroupXS()
    xs_shell3.LoadFromOpenMC("./materials/material_2_Steel_reflector/Steel_reflector_LANL70g.h5", "Steel_reflector", 294.0)
    ...
    vtk_basename = "PU_MET_FAST_032_case-2"
