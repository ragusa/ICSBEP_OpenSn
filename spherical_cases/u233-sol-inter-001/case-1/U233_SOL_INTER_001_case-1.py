...
# -*- coding: utf-8 -*-
"""
U233_SOL_INTER_001 case-1 benchmark
"""
...
if __name__ == "__main__":
    ...
    radii = {1: 7.8726000000000003, 2: 7.9208999999999996, 3: 15.9209}
    ...
    xs_shell1.LoadFromOpenMC("./materials/material_1_IEU_Flouride_Solution/IEU_Flouride_Solution_LANL70g.h5", "IEU_Flouride_Solution", 294.0)
    ...
    xs_shell3.LoadFromOpenMC("./materials/material_3_Beryllium_reflector/Beryllium_reflector_LANL70g.h5", "Beryllium_reflector", 294.0)
    ...
    vtk_basename = "U233_SOL_INTER_001_case-1"
